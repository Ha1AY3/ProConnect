...
import { postComment, getAllComments, incrementPostLike, deletePost, createPost, getAllPosts } from "@/src/config/redux/action/postAction";
            ...
            <div className={styles.scrollComponent}>
              ...
              <div className={styles.wrapper}>
                <div className={styles.createPostContainer}>
                  ...
                  }} value={postContent} className={styles.textAreaOfContent} placeholder={"What's in your mind?"} name="" id=""></textarea>
                ...
                <div className={styles.postsContainer}>
                  {postState.posts.filter(post => post.userId).map((post) => {
                    return(
                      <div key={post._id} className={styles.singleCard}>
                        <div className={styles.singleCard_profileContainer}>
                          <div className={styles.avatar}>
                            {authState.profileFetched && (
                            <img src={`${BASE_URL}/${post.userId.profilePicture}`} alt="profile"/>
                            )}
                          </div>
                          <div>
                            ...
                            <div className={styles.optionsContainer}>
                              ...
                              <div onClick={() => {
                                ...
                                const url = encodeURIComponent("twitter.com");
